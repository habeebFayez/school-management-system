...
import { mockCourses } from '../../data/MessagesData';
...
export const SendMessageModal = ({
  ...
  const availableStudents = selectedCourseData?.students || []; 

  const [selectedStudent, setSelectedStudent] = useState(replyTo?.senderId || '');
