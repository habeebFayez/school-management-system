          ...
          DayButton: (props) => {
            ...
            return (
              <button
                {...props}
                className={
                  "h-11 w-11 rounded-full transition-all duration-200 flex items-center justify-center " +
                  (isSelected
                    ? "bg-gradient-blue-500  text-white font-bold shadow-lg scale-110 border-2 border-white ring-2 ring-blue-300"
                    : isToday
